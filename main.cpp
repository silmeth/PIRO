...
void canny_window(int, void*){
	canny_blur_filter(src_gray, dst, 3, canny_low_threshold, 3);
...
void hough_canny_window(int, void*){
	Mat temp;
	canny_blur_filter(src_gray, temp, 3, 100, 3);
...
int main(int argc, const char** argv){
	/// Load an image
	src = imread( "/home/jacek/Studia/PIRO/face_rec_test/sheet.png" );
	if( !src.data )
	{ return -1; }
